/* ============================================================
   ...
   Every question carries a `topic` field (2026-07-21, matches the topic
   labels used in data/quiz-bank.js) so future breakdown/report changes
   don't require re-reading and re-categorizing every question.
   ============================================================ */
window.EXAM_DATA = {
